...
public class ExportService {
    ...
    public void gerarCSV(List<Vaga> vagas) {
        ...
        try (FileOutputStream fos = new FileOutputStream("vagas_vivendas.csv"))  {
            ...
            ImageIO.write(buff,"png", new File("vagas_vivendas.png"));
            Desktop.getDesktop().open(new File("vagas_vivendas.png"));
        } catch (Exception e) {
